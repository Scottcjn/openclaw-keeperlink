...
**Demo video (long, ETHGlobal submission):** https://youtu.be/LcTAyTK6o7A (2:16, narrated by Sophia Elya in her **Elyan Labs vintage voice**, both flows) — the version that meets the ETHGlobal 2-4 minute floor.
**Demo video (short canonical, 38s):** https://youtu.be/brC9l2QefhU · also on [BoTTube](https://bottube.ai/watch/iqXhl1N-N44) — same content, faster pace, fits BoTTube's science-tech 120s cap.
**Demo video (live LLM agent addendum, 40s):** https://youtu.be/QIU8s-jHG94 — Claude Sonnet 4.6 in the driver's seat: discover → quote → verify-balance → hire → independently-verify, every step a real tool call, every reasoning step shown live. Distinguishes "agent" from "script." · also on [BoTTube](https://bottube.ai/watch/ZrPDhpMFfwX)
